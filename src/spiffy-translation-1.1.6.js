...
spiffyTranslate = function( options ){
    ...
    var defaults = {
        ...
        payment_month: 'Month',
        payment_year: 'Year',
        paypal_notice: 'You have chosen to pay with PayPal. Your PayPal account will not be charged until you hit the "Complete my purchase!" button.',
        paypal_switch: 'Pay with credit card instead',
...
payment_hook = function(){
    ...
    jQuery('#paymentSelection .payPalDescription').text(translations.paypal_notice);
    jQuery('#paymentSelection #checkoutWithCreditCardLink.switchPaymentSelectionLink').text(translations.paypal_switch);

...
;( function( $, window, document, undefined ) {
    ...
    var pluginName = "upsells",
        defaults = {
            ...
            // order form actions
            action_checkout: $('.checkoutLinks .continueButton').attr('href'),
            action_upsell: $('.upsellButton').attr('onclick')
        };
    ...
    $.extend( Plugin.prototype, {
        ...
        spProcessOrder: function(){
            ...
            // process order
            eval(this.settings['action_checkout']);
            console.log('Processing Order: ' + this.settings['action_checkout']);
        ...
        spProcessUpsell: function(){
            ...
            console.log('Adding Upsell: ' + upsell.settings['action_upsell']);
            eval(upsell.settings['action_upsell']);
